...
const FeatureCardsSection = () => {
  ...
  return (
    <section className="bg-[var(--color-white)] tablet:pb-[160px] pb-0">
      <div
        ref={ref}
        className={`
        ...
        `}
      >
        <h3 className="mb-[36px] text-center text-xl2 font-bold text-[var(--color-black-pure)] desktop:text-left">
        ...
        <div className="grid grid-cols-1 justify-items-center gap-10 desktop:grid-cols-3 desktop:gap-[33px]">
          {cards.map((card) => (
            ...
            >
              <div
                className="
                  flex items-center justify-center rounded-t-[8px]
                  bg-[var(--color-gray-light)]
                  w-[343px] h-[235.93px]
                  tablet:w-[378px] tablet:h-[260px]
                "
              >
                <Image
                  src={card.img}
                  ...
                  className={`
                    w-[${card.mobileImgW}px] h-[${card.mobileImgH}px]
                    tablet:w-[${card.desktopImgW}px] tablet:h-[${card.desktopImgH}px]
                  `}
                />
              </div>
              ...
              <div
                className="
                  rounded-b-[8px] bg-[var(--color-gray-bg)]
                  px-6 py-5
                  w-[343px] h-[112.52px]
                  tablet:w-[378px] tablet:h-[124px]
                "
              >
